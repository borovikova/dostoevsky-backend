...
compose-tests:
	docker-compose -f docker-compose.test.yml build && docker-compose -f docker-compose.test.yml run pytest pytest tests --ds=app.settings && docker-compose -f docker-compose.test.yml run pytest pytest snapshot_tests --ds=app.settings
...
copy_snapshots:
	docker cp dostoevsky-backend_web_1:/home/app/web/snapshot_tests/snapshots /home/kate/dostoevsky-backend/app/snapshot_tests/snapshots
