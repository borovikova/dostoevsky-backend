...
class DataTests(TestCase):
    ...
    def test_data_parsing(self):
        call_command('fill_db', file=os.path.join(settings.BASE_DIR, 'tests', 'part', 'management', 'commands', 'test_files', 'test_data.pkl'))
        ...
        with open(os.path.join(settings.BASE_DIR, 'tests',  'part', 'management', 'commands', 'test_files', 'test_params.json'), 'r') as f:
